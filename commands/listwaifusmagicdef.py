...
@bot.command(description="|LISTING| Lists all of the waifus in the database for a given user based on their magical defense",
             aliases=("lwmdef",))
async def listwaifusmagicdef(ctx: commands.Context, starting_index: int = 1):
    """
    Lists all the waifus in the database for a given user, in a paged list of 15 waifus per, based
    on their magical defense.
